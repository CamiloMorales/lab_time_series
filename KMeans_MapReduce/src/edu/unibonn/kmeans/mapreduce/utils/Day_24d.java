...
public class Day_24d
{
	...
	public Day_24d(String sensor_id2, LocalDate now, double[] my_measurements)
	{
		this.sensor_id = sensor_id2;
		this.day = now;
		this.measurements = new double[24];
		
		for (int i = 0; i < my_measurements.length; i++)
		{
			measurements[i]=my_measurements[i];
		}
	}
	public String getId() {
		return sensor_id;
